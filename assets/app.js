...
function exportBackup(){
 const data={version:"Enterprise V1.2 Build 2A RC6 — Full Regression QA Hotfix 1",schema:STORAGE_SCHEMA_VERSION,exportedAt:new Date().toISOString(),orders,payments,tasks,roomLocks,guestProfiles,settings,shortcuts,templates,auditLogs,notificationState};
